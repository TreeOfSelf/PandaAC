...
public class MathUtil {
    ...
    public static HitResult raycastInDirection(PAEntity entity, double x, double y, double z, Vec3d direction, double maxDistance, RaycastContext.FluidHandling fluidHandling) {
