...
public class BlockCollisionUtil {
    ...
    public static boolean isNearby(PAPlayer player, double expandHorizontal, double expandVertical, BiPredicate<World, BlockPos> predicate) {
        return isTouching(player.getBox().expand(expandHorizontal, expandVertical, expandHorizontal), player.getWorld(), predicate);
    }

    public static boolean isNearby(PAPlayer player, double posx, double posy, double posz, double expandHorizontal, double expandVertical, BiPredicate<World, BlockPos> predicate) {
