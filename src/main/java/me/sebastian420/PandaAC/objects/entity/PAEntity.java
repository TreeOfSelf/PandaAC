...
import me.sebastian420.PandaAC.trackers.Tracker;
...
public interface PAEntity {
    ...
    @Nullable
    default PAEntity getVehicleCd() {
        return PAEntity.of(asMcEntity().getVehicle());
    }
    ...
    float _getEyeHeight(EntityPose pose);

    default float getEyeHeight(EntityPose pose) {
        return _getEyeHeight(pose);
    }
    ...
    default float getStepHeight() {
        return asMcEntity().getStepHeight();
    }
    ...
    default ServerWorld getWorld() {
        return (ServerWorld)asMcEntity().getWorld();
    }
    ...
    public static PAEntity of(Entity entity) {
        return (PAEntity)entity;
    }
}
