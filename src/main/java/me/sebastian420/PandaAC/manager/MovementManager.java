...
public class MovementManager {
    ...
    public static void receiveVelocity(ServerPlayerEntity player, EntityVelocityUpdateS2CPacket velocityData) {
        ...
        playerData.setStoredSpeed(prevVelocity + (Math.abs(velocityData.getVelocityX()) + Math.abs(velocityData.getVelocityZ())) * 5);
        playerData.setStoredSpeedVertical(prevVelocityVertical + Math.abs(velocityData.getVelocityY()) * 5);
    }
}